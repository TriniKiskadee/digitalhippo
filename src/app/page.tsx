...
const perks = [
    ...
    },
    {
        name: "For the Planet",
        icon: Leaf,
        description: "We've pledged 1% of sales to the presentation and restoration of the natural environment"
    },
]
            ...
            <MaxWidthWrapper>
                <div className={"py-20 mx-auto text-center flex flex-col items-center max-w-3xl"}>
                    ...
                    <p className={"mt-6 text-lg max-w-prose text-muted-foreground"}>
                        ...
                        Every asset on or platform is verified by our team to ensure

...
const Page = async ({searchParams}: PageProps) => {
    ...
    return(
        <main className={"relative lg:min-h-full"}>
            ...
            <div>
                <div
                    className={"mx-auto max-w-2xl px-4 py-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24"}>
                    <div className={"lg:col-start-2"}>
                        ...
                        {order._isPaid ? (
                            <p className={"mt-2 text-base text-muted-foreground"}>
                                ...
                                for download below. We&apos;ve sent your receipt and order details to{" "}
                        ...
                        <div className={"mt-16 text-sm font-medium"}>
                            ...
                            <div
                                ...
                                <div
                                    className={"flex items-center justify-between border-t border-gray-200 pt-2 text-gray-900"}>
